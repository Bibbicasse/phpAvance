        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <section id="modifier">
                <div class="row m-1 py-0">
                    ...
                    <!-- **********************************************-->
                    <div class="col-sm-12 col-lg-2 mt-2 border border-secondary  border-5 rounded-3">
                        <div class="d-flex flex-column align-items-center text-center 2">
                            <!-- **********************************************-->
                            <!--               IMG PROFILE -->
                            <!-- **********************************************-->
                            <img class="rounded-circle mt-5 img-circle" width="150" height="150" src="<?= 'uploads/file_profile_' . $current_user . '' ?>" alt="Profile - Photo">
                    ...
                    <!--           PARAMETRE PROFILE                   -->
                    <!-- **********************************************-->
                    <div class="col-sm-12 col-lg-6 mt-2 mx-auto  border border-secondary  border-5 rounded-3 ">
                        <div class="p-3 py-2">
                    ...
                    <!-- **********************************************-->
                    <div class="col-sm-12 col-lg-3 mt-2 mx-auo pt-2 border border-secondary  border-5 rounded-3">
                ...
                <div class="row m-2">
                    ...
                    <!-- **********************************************-->
                    <div id="competences" class="col-sm-12 mx-auto border border-secondary  border-5 rounded-3 py-2 mt-2">
                            <div class="mx-auto text-center justify-content-between align-items-center mb-3">
                                <div id="squarePlus" class="row">
                                    ...
                                    <div class="col-sm-2 col-lg-1 mx-auto">
                                        <svg id="skillsPLUS" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16" onclick="competence_add()">
                ...
                <div class="row m-2">
                    ...
                    <!--           PARAMETRE PORTFOLIO               -->
                    <!-- **********************************************-->
                    <div class="col-sm-12 mx-auto border border-secondary  border-5 rounded-3 py-2 mt-2">
                        <div class="">
                            <div class="mx-auto text-center justify-content-between align-items-center mb-3">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="form-group col-sm-12 col-lg-6">
                                    ...
                                    <div>
                                        ...
                                        <small class=""><em><a href="https://www.ilovepdf.com/fr/pdf_en_jpg">Convertir PDF en JPG</a></em></small>
                                    </div>
                                </div>
                            </div>
                        </div>
