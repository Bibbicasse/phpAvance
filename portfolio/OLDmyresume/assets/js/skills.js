function competence_add()
{
    ...
    new_competence.innerHTML = `
        <div class="col-8">
            <input name="competence" type="text" class="form-control" placeholder="Description" value="">
        </div>
        <div class="col-1">
            <input name="valeur" type="number" class="form-control" placeholder="" value="">
        </div>
        <div class=" col-1 mx-0">
            <input name="couleur" type="color" id="colorSkills" name="colorSkills" class="form-control" value="">
        </div>
