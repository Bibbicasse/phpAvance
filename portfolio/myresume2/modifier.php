...
<head>
    ...
    <title><?= $fiche['prenom'] ?? '' ?> <?= $fiche['nom'] ?? '' ?></title>
...
<body>
    ...
    <main id="main">
        ...
        <div class="container rounded-3 bg-white mt-5 mb-5">
            <h2 id="h2accueil" class=" text-center mx-auto col-12 col-md-12 col-lg-6">GESTIONNAIRE PROFILE</h2>
                ...
                <section id="modifier">
                    <div class="row m-1 py-2">
                            ...
                            <div class="p-3 py-5">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nom" value="<?= $fiche['nom'] ?? '' ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="labels">Prénom</label>
                                        <input type="text" class="form-control" value="<?= $fiche['prenom'] ?? '' ?>" placeholder="Prenom">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <label class="labels">Téléphone</label>
                                        <input type="text" class="form-control" placeholder="Ton numéro" value="<?= $fiche['telephone'] ?? '' ?>">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="labels">Adresse</label>
                                        <input type="text" class="form-control" placeholder="Numero et rue" value="<?= $fiche['adresse'] ?? '' ?>">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="labels">Complément Adresse</label>
                                        <input type="text" class="form-control" placeholder="Complément adresse" value="<?= $fiche['complement'] ?? '' ?>">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="labels">Code postal</label>
                                        <input type="text" class="form-control" placeholder="ex. 75000" value="<?= $fiche['code_postal'] ?? '' ?>">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="labels">Email</label>
                                        <input type="email" class="form-control" placeholder="Ton email" value="<?= $fiche['email'] ?? '' ?>">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="labels">Education</label>
                                        <input type="text" class="form-control" placeholder="Education" value="<?= $fiche['education'] ?? '' ?>">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        <label class="labels">Âge</label>
                                        <input type="number" class="form-control" placeholder="Age" value="<?= $fiche['age'] ?? '' ?>">
                                    </div>
                                    <div class="col-6">
                                        <label class="labels col-12">Disponibilité</label>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1" <?= $fiche['disponibilite'] == '1' ? 'checked' : '' ?>>
                                            <!-- condition abrégé '?' simple = if dans le php -->

                                            <label class="form-check-label" for="inlineRadio1">Oui</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="0" <?= $fiche['disponibilite'] == '0' ? 'checked' : '' ?>>
                                            <!-- condition abrégé '?' simple = if dans le php -->
                        ...
                        <div class="mx-auo col-3 pt-5 border border-info  border-5 rounded-3">
                            <div class="p-3 py-0 ">
                                <h4 class="text-right">Professionnel</h4>
                                ...
                                <div class="col-md-12"><label class="labels">Métier</label><input type="text" class="form-control" placeholder="Metier" value="<?= $fiche['metier'] ?? '' ?>"></div> <br>
                            ...
                            <div class="p-3 py-0">
                                ...
                                <div class="col-md-12"><label class="labels">Website</label><input type="text" class="form-control" placeholder="Lien" value="<?= $fiche['website'] ?? '' ?>"></div>
                                <div class="col-md-12"><label class="labels">Twitter</label><input type="text" class="form-control" placeholder="Lien" value="<?= $fiche['twitter'] ?? '' ?>"></div>
                                <div class="col-md-12"><label class="labels">Facebook</label><input type="text" class="form-control" placeholder="Lien" value="<?= $fiche['facebook'] ?? '' ?>"></div>
                                <div class="col-md-12"><label class="labels">instagram</label><input type="text" class="form-control" placeholder="Lien" value="<?= $fiche['instagram'] ?? '' ?>"></div>
                                <div class="col-md-12"><label class="labels">Github</label><input type="text" class="form-control" placeholder="Lien" value="<?= $fiche['github'] ?? '' ?>"></div>
                                <div class="col-md-12"><label class="labels">Linkedin</label><input type="text" class="form-control" placeholder="Lien" value="<?= $fiche['linkedin'] ?? '' ?>"></div>
                            </div>
                        </div>
                    </div> <!-- fin row profile -->
                    <div class="row m-2">
                            ...
                            <div class="">
                                ...
                                <div class="row mt-2 mx-auto col-12">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Description" value="<?= $fiche['description_competence'] ?? '' ?>">
                                    </div>
                                    <div class=" col-9">
                            ...
                            <div class="p-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-12 mx-auto">
                                        ...
                                        <textarea name="accroche_footer" id="accoche" cols="145" rows="5"><?= $fiche['accroche_footer'] ?? '' ?></textarea>
                                    </div>
                            ...
                            <div class="">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Description" value="<?= $fiche['description_portfolio'] ?? '' ?>">
                                    </div>
                                    <form class="col-md-6">
                        ...
                        <div class="col-12 mx-auto border border-success  border-5 rounded-3 py-2">
                            <div class="">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <label class="labels">Description</label>
                                        <input type="text" class="form-control" placeholder="Description" value="<?= $fiche['description_cv'] ?? '' ?>">
                                    </div>
                                    <form class="col-md-6">
                                        <label class="labels">Fichiers</label>
                                        <div class="form-group">
