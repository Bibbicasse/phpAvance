...
<!-- ======= Hero Section ======= -->
  ...
  <main id="main">
    ...
    <div class="row">
      <div class="col-6 mx-auto mt-3 p-0">
        <div class="card">
            <div class="login-box">
                        ...
                        <form method="POST">
                          <div class="login">
                              <div class="group"> 
                                ...
                                <input name="username" type="text" class="input" placeholder="Entre ton nom utilisateur"> 
                              </div>
                              <div class="group"> 
                                <label for="psw" class="label text-white">Mot de passe</label> 
                                <input name="password" type="password" class="input" data-type="password" placeholder="Entre ton mot de passe"> 
                              </div>
                              <!-- <div class="group"> 
                              ...
                              <div class="foot text-white"> 
                                ...
                                <br>
                                <a href="index.html" class="my-2">Accueil</a> 
