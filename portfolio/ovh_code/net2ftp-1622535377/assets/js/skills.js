function competence_add()
{
    ...
    new_competence.classList.add("row", "mx-auto", "col-12")
    new_competence.innerHTML = `
        <div class="col-9">
            <input name="competences_new[]" type="text" class="form-control" placeholder="Description" value="">
        </div>
        <div class="col-1">
            <input name="valeurs_new[]" type="number" class="form-control" placeholder="" value="">
        </div>
        <div class=" col-1 mx-0">
            <input name="couleurs_new[]" type="color" id="colorSkills" name="colorSkills" class="form-control form-control-color" value="">
        </div>
